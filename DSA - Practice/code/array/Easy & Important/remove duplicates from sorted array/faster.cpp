...
- Whenever a unique element is found, copy the value of this unique element to the locationPointer which will be pointing to the location where first duplicate element was found
