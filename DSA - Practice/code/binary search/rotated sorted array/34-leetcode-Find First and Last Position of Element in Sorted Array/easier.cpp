/*
SOLUTION: https://www.youtube.com/watch?v=w2G2W8l__pc

NOTE: whenever a question mentions about solving for duplicates, first take the 
approach of solving with unique elements and then try to find a case where the 
unique element code will fail and then you can find the solution for duplicates by 
adding those special condition checks.
